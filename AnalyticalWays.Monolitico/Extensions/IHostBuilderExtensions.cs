...
namespace Microsoft.Extensions.Hosting {
    ...
    public static class IHostBuilderExtensions {
        private const string _configurServiceMethod = "ConfigureServices";
        /// <summary>
        /// Permite la configuración de los servicios utilizando una clase de inicialización
        /// </summary>
        ...
        public static IHostBuilder UseStartup<TStartup>(this IHostBuilder hostBuilder) {
            ...
            MethodInfo configureServiceMethod = typeof(TStartup).GetMethod(_configurServiceMethod, new Type[] { typeof(IServiceCollection) });
